...
| **get_no_index** | **Python** | 2,288.60 ± 170.13 | 449.78 ± 0.68 | 8.45ms / 16.19ms | 44.02ms / 46.29ms | -80.3% BME เร็วกว่า |
| **get_no_index** | **Python (opt.)** | 3,228.25 ± 195.23 | 2,814.82 ± 431.46 | 5.71ms / 11.14ms | 6.15ms / 17.14ms | -12.8% BME เร็วกว่า |
...
| **get_with_index** | **Python** | 2,279.05 ± 238.58 | 449.66 ± 0.64 | 8.14ms / 15.60ms | 44.02ms / 46.06ms | -80.3% BME เร็วกว่า |
| **get_with_index** | **Python (opt.)** | 3,220.85 ± 243.42 | 2,913.31 ± 504.98 | 5.56ms / 11.52ms | 5.94ms / 14.43ms | -9.5% BME เร็วกว่า |
