...
def main():
    ...
    with open(os.path.join(raw_res_dir, "get_with_index_dkr_raw.json"), "w") as f:
        json.dump(RAW_RESULTS, f, indent=2)

    print("\n=================================================================")
    print(" GET With-Index Docker Benchmark Finished!")
    print(" Averaged Results in: dkr_benchmark_results.json & results/get_with_index_dkr.json")
    print(" Raw Iteration Results in: raw_results.json & results/raw_results/get_with_index_dkr_raw.json")
    print("=================================================================")
