...
def main():
    ...
    with open(os.path.join(raw_res_dir, "get_with_index_bme_raw.json"), "w") as f:
        json.dump(RAW_RESULTS, f, indent=2)

    print("\n=================================================================")
    print(" GET With-Index Bare-Metal Benchmark Finished!")
    print(" Averaged Results in: bme_benchmark_results.json & results/get_with_index_bme.json")
    print(" Raw Iteration Results in: raw_results.json & results/raw_results/get_with_index_bme_raw.json")
    print("=================================================================")
